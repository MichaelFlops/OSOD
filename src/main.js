...
var code, converter, counter, diskOutdated, download, filePicker, hideCode, hideCodeButton, i, load, load2, markdown, outputarea, possiblyUpdate, renderOutdated, save, showCode, showCodeButton, textarea;

for (counter = i = 0; i <= 20; counter = ++i) {
...
possiblyUpdate = function() {
  var all_js, e, error, f, j, js, jsa, len, md, n;
  ...
  all_js = '';
  for (n = j = 0, len = jsa.length; j < len; n = ++j) {
    js = jsa[n];
    all_js += js;
